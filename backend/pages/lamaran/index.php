...
$lamaran ="SELECT * FROM lamaran";
$result = mysqli_query($connect, $lamaran) or die(mysqli_error($connect));
?>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Halaman Data lamaran</h2>
                </div>
            </div>
        </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="../../../storages/lamaran/<?= $item->image ?>" alt="Gambar" width="100" height="100">
                                        </td>
                                       <td class="text-center">
    Rp <?= number_format($item->harga, 0, ',', '.') ?>
                                        ...
                                        <td>
                                                        <div class="d-flex justify-content-center gap-2">
                                                            ...
                                                            <a href="../../actions/lamaran/destroy.php?id=<?= $item->id ?>"
