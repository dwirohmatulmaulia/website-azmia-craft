...
$result = mysqli_query($connect, $social_media) or die(mysqli_error($connect));
?>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Halaman Data social_media</h2>
                </div>
            </div>
        </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="../../../storages/social_media/<?= $item->image ?>" alt="Gambar" width="100" height="100">
                                        </td>
