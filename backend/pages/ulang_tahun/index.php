...
$ulang_tahun ="SELECT * FROM ulang_tahun";
$result = mysqli_query($connect, $ulang_tahun) or die(mysqli_error($connect));
?>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Halaman Data ulang_tahun</h2>
                </div>
            </div>
        </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="../../../storages/ulang_tahun/<?= $item->image ?>" alt="Gambar" width="100" height="100">
                                        </td>
                                       <td class="text-center">
