...
$set_cangkir ="SELECT * FROM set_cangkir";
$result = mysqli_query($connect, $set_cangkir) or die(mysqli_error($connect));
?>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Halaman Data set_cangkir</h2>
                </div>
            </div>
        </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="../../../storages/set_cangkir/<?= $item->image ?>" alt="Gambar" width="100" height="100">
                                        </td>
                                       <td class="text-center">
    Rp <?= number_format($item->harga, 0, ',', '.') ?>
                                        ...
                                        <td>
                                                        <div class="d-flex justify-content-center gap-2">
                                                            ...
                                                            <a href="../../actions/set_cangkir/destroy.php?id=<?= $item->id ?>"
